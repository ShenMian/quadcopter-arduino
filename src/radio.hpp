...
{
public:
	Radio(uint8_t ce, uint8_t csn, const uint8_t* write_address, const uint8_t* read_address)
	{
		radio_.begin(ce, csn);
	...
	{
		static_assert(sizeof(T) <= 32, "nRF24L01 maximum payload size is 32 bytes");
